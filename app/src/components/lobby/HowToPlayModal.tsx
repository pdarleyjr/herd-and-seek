...
const RULES = [
  ...
  { icon: "🎯", color: "#ff6b6b", title: "You Are the Hunter — Aim & Tag",
    text: "You have limited ammo. Find the REAL players hiding among hundreds of NPC animals. Aim your crosshair, then click or tap FIRE. On phones, drag the right side and release to shoot. Run out of ammo and animals win." },
  ...
  { icon: "📱", color: "#88aaff", title: "Mobile & Tablet Controls",
    text: "Animals: drag the LEFT side to move, tap your perk button to activate.\nHunter:\n• Phones → left thumb moves, right thumb drags to aim, and releasing fires.\n• Tablets / desktop → keep the FIRE button for precise shots.\n• Aim assist softly nudges shots toward the nearest animal on touch devices.\n• The screen will not scroll or zoom." },
