...
const RULES = [
  ...
  },
  {
    ...
    text: "One player is the Hunter. Locate the real players hiding among the NPCs. Aim and tap the FIRE button to shoot them. Don't waste all your ammo on misses!",
    color: "#ff6b6b",
  },
  {
    icon: "🦓",
  ...
  },
  {
    ...
    text: "Animals: drag left side to move, tap perk button to use upgrade.\nHunter: drag left to move · drag right side to aim crosshair · tap the big FIRE button to shoot.",
    color: "#88aaff",
  },
  {
    icon: "🎮",
