...
const RULES = [
  ...
  },
  {
    ...
    text: "One player is the Hunter. Locate the real players hiding among the NPCs. Aim and click or tap the FIRE button to shoot them. On phones, drag the right side and release to fire. Don't waste all your ammo on misses!",
    color: "#ff6b6b",
  },
  {
    icon: "🦓",
  ...
  },
  {
    ...
    text: "Animals: drag left side to move, tap perk button to use upgrade.\nHunter: drag left to move · phones use drag-to-aim and release-to-fire · tablets / desktop can still use the big FIRE button.",
    color: "#88aaff",
  },
  {
    icon: "🎮",
